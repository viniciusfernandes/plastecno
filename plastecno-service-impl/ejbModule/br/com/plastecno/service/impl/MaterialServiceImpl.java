...
public class MaterialServiceImpl implements MaterialService {
	...
	public PaginacaoWrapper<Material> paginarMaterial (Material filtro, Boolean apenasAtivos,
		...
		return new PaginacaoWrapper<Material>(
	...
	public Integer inserir(Material material, List<Integer> listaIdRepresentadaAssociada) throws BusinessException {
		...
		if (material.getId() == null && (material.getListaRepresentada() == null || material.getListaRepresentada().isEmpty())) {
	...
	@Override
	public List<Material> pesquisarBy(Material filtro, Boolean apenasAtivos,
			Integer indiceRegistroInicial, Integer numeroMaximoRegistros) {
	...
	public List<Material> pesquisarBySigla(String sigla, Integer idRepresentada) {
		Query query = this.entityManager.createQuery(
				"select new Material(m.id, m.sigla, m.descricao) from Material m inner join m.listaRepresentada r where r.id = :idRepresentada and m.sigla like :sigla order by m.sigla ");
	...
	public boolean isCalculoIPIObrigatorio(Integer idMaterial, Integer idRepresentada) {
		...
		.append("inner join m.listaRepresentada r where m.id = :idMaterial and ")
		.append("r.id = :idRepresentada ");
