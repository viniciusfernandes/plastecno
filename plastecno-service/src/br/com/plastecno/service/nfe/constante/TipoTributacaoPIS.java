...
public enum TipoTributacaoPIS {
	...
	PIS_6("06 - Oper. Tributável alíquota zero", "6"),
	PIS_7("07 - Oper. isenta contribuição", "7"),
	PIS_8("08 - Oper. sem incidência contribuição", "8"),
	PIS_9("09 - Oper. com suspensão contribuição", "9"),
