	...
	<div id="content">
		...
		<form action="<c:url value="/login/entrar"/>" method="post">
			<div class="bloco_autenticacao flutuante_esquerda">
				<input type="submit" value="" class="botaoLogin"
					title="Entrar no sistema" /> <input type="password" id="sigla"
					name="senha" style="width: 8%" /> <label>Senha:</label> <input
					type="text" id="sigla" name="email" style="width: 25%" /> <label>Email:</label>
			</div>
		</form>
