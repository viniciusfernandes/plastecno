	...
	<jsp:include page="/bloco/bloco_mensagem.jsp" />
		...
		<fieldset>
			<legend>::: SQL Editor :::</legend>
					...
					<form action="<c:url value="/administracao/sql/execucao"/>" method="post">
						
							<textarea id="query" name="query" style="width: 100%; height: 150px" class="uppercaseBloqueado">${query}</textarea>
							<div class="bloco_botoes">
								<input type="submit" value="" class="botaoPesquisar" style="width: 5%"/>
							</div>
					...
					<div class="input" style="width: 80%">
						<textarea id="resultado" style="width: 100%; height: 400px" class="uppercaseBloqueado">${resultado}</textarea>
					</div>
		</fieldset>
</body>
</html>