...
2) Copiar os arquivos para a construção do esquema "criacao_tabela_enderecamento.sql" e "update_tabela_enderecamento.sql"
via "wiscp" para o diretorio /home
...
5.1) É muito importante executar o comando especificando o caminho até o diretório utilizando o slash ("/")
