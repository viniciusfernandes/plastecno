...
alter table vendas.tb_item_estoque add constraint id_limite_minimo_estoque foreign key (id_limite_minimo_estoque) references vendas.tb_limite_minimo_estoque (id);
